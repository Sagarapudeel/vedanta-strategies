...
export const initialData = {
  ...
  siteContent: {
    hero: {
      badge_en: "Putalisadak, Kathmandu • Hands-on Lab & Studio",
      badge_ne: "पुतलीसडक, काठमाडौं • प्रयोगात्मक ल्याब र स्टुडियो",
      title_en: "Practical AI, Media & Digital Skills for Nepal",
      title_ne: "नेपालका लागि व्यावहारिक एआई, मिडिया तथा डिजिटल सीप",
      subtitle_en: "Learn practical digital tools on your own laptop, record podcasts in our Putalisadak studio, and grow your institution with targeted marketing.",
      subtitle_ne: "आफ्नै ल्यापटपमा व्यावहारिक डिजिटल टुल्स सिक्नुहोस्, हाम्रो पुतलीसडक स्टुडियोमा पोडकास्ट रेकर्ड गर्नुहोस् र संस्थाको व्यवसाय बढाउनुहोस्।",
      ...
      ctaPrimary_en: "Explore Training Programs",
    ...
    pillars: {
      learning_title_en: "1. Learning (Hands-on Training)",
      learning_title_ne: "१. सिकाइ (व्यावहारिक तालिम)",
      learning_desc_en: "Small batches (max 15), guided practice on your own laptop in Putalisadak, and school workshops.",
      learning_desc_ne: "सानो ब्याच (अधिकतम १५ जना), पुतलीसडकमा आफ्नै ल्यापटपमा अभ्यास र विद्यालय कार्यशाला।",
      production_title_en: "2. Production (Acoustic Studio)",
      production_title_ne: "२. निर्माण (अडियो/भिडियो स्टुडियो)",
      production_desc_en: "Clean podcast recording, corporate interviews, documentaries, and social media reels.",
      production_desc_ne: "उच्च गुणस्तरीय पोडकास्ट रेकर्डिङ, संस्थागत अन्तर्वार्ता, वृत्तचित्र र सामाजिक सञ्जाल रिल्स।",
      collaboration_title_en: "3. Collaboration (Agency Growth)",
      collaboration_title_ne: "३. सहकार्य (डिजिटल वृद्धि)",
      collaboration_desc_en: "Facebook & Instagram ad funnels directly connected to WhatsApp for colleges and local businesses.",
      collaboration_desc_ne: "कलेज तथा स्थानीय व्यवसायहरूका लागि ह्वाट्सएपसँग जोडिएका लक्षित विज्ञापन अभियान।"
    },
    about: {
      story_en: "We started Vedanta Strategies in Putalisadak with a simple conviction: technology training in Nepal shouldn't be about dry slideshows or confusing buzzwords. It should be hands-on, practical, and immediately useful for your daily job, college studies, or local business.",
      story_ne: "हामीले पुतलीसडकमा एउटा स्पष्ट उद्देश्यका साथ वेदान्त स्ट्राटेजिज सुरु गरेका हौँ: नेपालमा प्रविधि तालिम केवल जटिल सैद्धान्तिक स्लाइडहरूमा सीमित हुनुहुँदैन। यो व्यावहारिक, हातैले गर्ने अभ्यास र दैनिक कार्यालय वा व्यवसायमा तत्काल उपयोगी हुनुपर्छ।"
    },
    cta: {
      title_en: "Visit Our Putalisadak Campus or Discuss Your Project",
      title_ne: "हाम्रो पुतलीसडक कार्यालय आउनुहोस् वा परियोजनाबारे छलफल गर्नुहोस्",
  ...
  courses: [
    {
      ...
      mode: "Putalisadak Campus or Live Online",
      mode_en: "Putalisadak Campus or Live Online",
      mode_ne: "पुतलीसडक ल्याब वा प्रत्यक्ष अनलाइन",
      fee: 14000,
    ...
    },
    {
      ...
      mode: "Putalisadak Physical Lab",
      mode_en: "Putalisadak Physical Lab",
      mode_ne: "पुतलीसडक भौतिक ल्याब",
      fee: 18000,
    ...
    },
    {
      ...
      duration_en: "6 Weeks (36 Hours)",
      duration_ne: "६ हप्ता (३६ घण्टा)",
      mode: "Physical Studio Lab (Putalisadak)",
      mode_en: "Physical Studio Lab (Putalisadak)",
      mode_ne: "पुतलीसडक भौतिक स्टुडियो ल्याब",
      fee: 16000,
      mentor: "Aarav Karki",
      featured: true,
  ...
  testimonials: [
    ...
    },
    {
      ...
      quote_en: "We recorded our 6-episode podcast at their Putalisadak studio. The sound quality was crystal clear, the lighting was warm, and the editors delivered the files on time. Will definitely record here again.",
      quote_ne: "हामीले ६ शृङ्खलाको पोडकास्ट उहाँहरूको पुतलीसडक स्टुडियोमा रेकर्ड गर्यौँ। आवाज एकदमै सफा, प्रकाश व्यवस्थापन उत्कृष्ट र समयमै भिडियो प्राप्त भयो।",
      avatar: "SM"
    },
    {
      id: "t-3",
  ...
  teamMembers: [
    ...
    },
    {
      ...
      bio_en: "Videographer and podcast producer who manages our Putalisadak studio and shoots client video projects.",
      bio_ne: "पुतलीसडक स्टुडियो व्यवस्थापन गर्ने तथा वृत्तचित्र र पोडकास्ट निर्माणमा दक्ष अनुभवी भिडियोग्राफर।",
      avatar: "AK"
    },
    {
      id: "tm-bibek",
...
- इन्टरनेटबाट डाउनलोड गरिएका फोटोको सट्टा आफ्नै पसल वा उत्पादनको १५ सेकेन्डको वास्तविक भिडियो प्रयोग गर्ने।`
  ...
  siteSettings: {
    ...
    address_en: "Putalisadak (Near Star Mall), Kathmandu 44600, Nepal",
    address_ne: "पुतलीसडक (स्टार मल नजिकै), काठमाडौं ४४६००, नेपाल",
