...
export default function Footer({ currentLang, setActivePage, openLeadModal, siteSettings }) {
  ...
  return (
    <footer className="main-footer" style={{ background: '#1C2F4D', color: '#e2e8f0', paddingTop: '56px', paddingBottom: '32px' }}>
        ...
        <div className="footer-grid" style={{ marginBottom: '48px' }}>
          ...
          <div className="footer-brand-col">
            ...
            <div className="footer-social-row">
              <a href={siteSettings?.facebookUrl || "#"} target="_blank" rel="noopener noreferrer" className="footer-social-link" title="Facebook">
              ...
              <a href={siteSettings?.linkedinUrl || "#"} target="_blank" rel="noopener noreferrer" className="footer-social-link" title="LinkedIn">
              ...
              <a href={siteSettings?.instagramUrl || "#"} target="_blank" rel="noopener noreferrer" className="footer-social-link" title="Instagram">
          ...
          <div>
            ...
            <div className="footer-contact-info">
              <div className="footer-contact-row">
                <MapPin size={16} color="var(--brand-navy)" style={{ flexShrink: 0, marginTop: '2px' }} />
                <span>{getLangText(siteSettings, 'address', currentLang) || siteSettings?.address || 'Bagbazar, Kathmandu 44600, Nepal'}</span>
              </div>
              <div className="footer-contact-row">
                <Phone size={16} color="var(--brand-navy)" style={{ flexShrink: 0 }} />
